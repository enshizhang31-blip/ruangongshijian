...
('超级管理员', 'SUPER_ADMIN', '拥有所有权限', '["spu:view","spu:add","spu:edit","spu:delete","spu:import","spu:export","spu:status","sku:view","sku:add","sku:edit","sku:delete","category:view","category:add","category:edit","category:delete","spec:view","spec:add","spec:edit","spec:delete","sn:view","sn:add","sn:import","sn:export","sn:generate","sn:query","sn:status","customer:view","customer:detail","customer:edit","customer:balance","customer:points","customer:disable","order:view","order:detail","order:process","order:refund","statistics:view","system:user","system:role","system:menu","system:log"]', '["/dashboard","/product","/product/list","/sn","/sn/list","/order","/order/list","/customer","/customer/list","/statistics","/system","/system/user","/system/role"]', 1, 1, NOW(), NOW()),
...
('admin', '$2a$10$9Fr2OrEUefhFyxvFEviIg.kHuXtbYVT44sQyFk9MSaAbDksT1Z.mK', '系统管理员', '["spu:view","spu:add","spu:edit","spu:delete","spu:import","spu:export","spu:status","sku:view","sku:add","sku:edit","sku:delete","category:view","category:add","category:edit","category:delete","spec:view","spec:add","spec:edit","spec:delete","sn:view","sn:add","sn:import","sn:export","sn:generate","sn:query","sn:status","customer:view","customer:detail","customer:edit","customer:balance","customer:points","customer:disable","order:view","order:detail","order:process","order:refund","statistics:view","system:user","system:role","system:menu","system:log"]', '["/dashboard","/product","/product/list","/sn","/sn/list","/order","/order/list","/customer","/customer/list","/statistics","/system","/system/user","/system/role"]', 1, NOW(), NOW());
